  ...
  return (
    ...
    >
      {state.toasts.map((toast) => (
        <div
          key={toast.id}
          className={`rounded-lg px-3 py-2 type-body-md shadow-lg animate-slideUp pointer-events-auto flex items-center justify-between gap-2 ${variantClasses[toast.variant]}`}
          role="status"
        >
